...
def Direct_Collocation_Constraint_Objective_Plot_d1(SimDataName):
    ...
    _ = [x.set_xticklabels('') for x in ax[:-1]]
    os.makedirs(PLOT_DIRECTORY + '/Collocation_Constraints/', exist_ok=True)
    fig.savefig(PLOT_DIRECTORY + '/Collocation_Constraints/' + SimDataName + '.pdf')
...
def Direct_Collocation_Theta_Constraint_Plot_d1(SimDataName):
    ...
    _ = [x.set_xticklabels('') for x in ax[:-1]]
    os.makedirs(PLOT_DIRECTORY + '/Collocation_Constraints/', exist_ok=True)
    fig.savefig(PLOT_DIRECTORY + '/Collocation_Constraints/' + SimDataName + '_theta.pdf')
...
def Direct_Collocation_Bounds_Plot_d1(SimDataName):
    ...
    # _  = [x.set_ylim([-ys, ys]) for ys, x in zip(yscales, ax[:-1])]
    _ = [x.set_xticklabels('') for x in ax[:-1]]
    os.makedirs(PLOT_DIRECTORY + '/Collocation_Bounds/', exist_ok=True)
    fig.savefig(PLOT_DIRECTORY + '/Collocation_Bounds/' + SimDataName + '.pdf')
...
def Direct_Collocation_Theta_Bounds_Plot_d1(SimDataName):
    ...
    os.makedirs(PLOT_DIRECTORY + '/Collocation_Bounds/', exist_ok=True)
    fig.savefig(PLOT_DIRECTORY + '/Collocation_Bounds/' + SimDataName + '_theta.pdf')
