...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{pythonProject/Figures/Multiple_Shooting_Trajectory_IPOPT_traj_initial.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{pythonProject/Figures/Multiple_Shooting_bounds_IPOPT_traj_initial.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{pythonProject/Figures/Multiple_Shooting_obj_con_IPOPT_traj_initial.eps}
...
\begin{figure}[H]
    ...
    \caption{Trajectories with multiple shooting using IPOPT (Objective value: $-1.44\times 10^{13}$)}
    \label{fig:MS_Traj_IPOPT}
\end{figure}
