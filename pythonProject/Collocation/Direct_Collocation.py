...
if __name__ == '__main__':
    ...
    # opts["ipopt"]["output_file"] = r'C:/Users/jonas/OneDrive/Dokumenter/ntnu_Covid/Data/log.opt'
    opts["ipopt"]["file_print_level"] = 8
    opts["ipopt"]["print_frequency_iter"] = iter_step
    opts["calc_f"] = True
    opts["calc_g"] = True
    opts["calc_lam_p"] = True
    opts["calc_lam_x"] = True
    opts["calc_multipliers"] = True


    CB = DataCallback('DataCallback', NV, Ng, 0, 1,iter_step,d)
