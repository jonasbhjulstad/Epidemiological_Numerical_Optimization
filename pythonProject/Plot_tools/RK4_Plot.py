...
def Trajectory_Plot(SimDataName):
    ...
    fig.savefig(parent + '/overleaf/Figures/Trajectories/' + SimDataName + '.pdf')
...
def Bounds_Objective_Plot(SimDataName):
    ...
    fig.savefig(parent + '/overleaf/Figures/Bounds_Objectives/' + SimDataName + '.pdf')
...
def Constraint_Objective_Plot(SimDataName):
    ...
    _ = [x.set_xticklabels('') for x in ax[:-1]]
    fig.savefig(parent + '/overleaf/Figures/Constraint_Objectives/' + SimDataName + '.pdf')
